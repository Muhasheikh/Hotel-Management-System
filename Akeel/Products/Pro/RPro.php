...
<div class="leftt">
	<div class="headerFooter">
			...
			<div class="logoP">
					<a href="../../../Muhassan/UserDetails.php">
...
<div class="left">
	<div class="Album">
		...
		<?php
		$A=$_GET['id'];
            $query = "SELECT * FROM room Where Hotel_id='$A'";
...
<div class="leftt">
	<div class="headerFooter">
				...
				<div class="explore padding2">
					...
					<a href="../../../Muhassan/about.php"> About Us </a><br>
					<a href="../../../Nusky/ContactUs.php"> Contact Us </a><br>
					<a href="#">Blog</a>
				</div>
