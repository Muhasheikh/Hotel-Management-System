            ...
            if(mysqli_num_rows($result) > 0) {
                ...
                while ($row = mysqli_fetch_array($result)) {
                   ...
                   ?>
					...
					<div class="gallery">
							<img src="<?php echo $row["Hotel_imgPath"];?>">
								<div class="desc">
								<div class="d1"><label id="RoomName"> <?php echo $row["HotelName"]; ?></label></div>
								<div class="d3"> <label id="location"> <?php echo $row["Hotel_desc"]; ?> <br> Address :<?php echo $row["HotelAddress"]; ?>  </label>
								</div>
								<div class="d2"><label id="Rs">Email: <?php echo $row["Email"]; ?></label></br>
								<label id="location"> Phone: <?php echo $row["HotelPhone"]; ?></label></br>
								<label id="location"> </label></div><br>
								<div class="d2"><a href="RPro.php?id=<?php echo $row["HotelID"];?>"><button> View Rooms </button></a></div>
							</div>
					</div>
					<?php
                }
